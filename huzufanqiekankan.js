...
ui.ok.click(function () {
    ...
    <com.stardust.autojs.core.console.ConsoleView    id="consoleLog"   />\
        ...
        function getjieshouCount() {
            let temp = null;
            try {
                temp = http.post("116.205.139.36:8081/fanqie/getjieshouCount", {});
        ...
        function addjieshouCount() {
            let temp = null;
            try {
                temp = http.post("116.205.139.36:8081/fanqie/addjieshouCount", {});
                if (temp && temp.statusCode == 200) {
                    temp = temp.body.string();
                    let rep = JSON.parse(temp);
                    let repState = rep["state"];
        ...
        function reducejieshouCount() {
            let temp = null;
            try {
                temp = http.post("116.205.139.36:8081/fanqie/reducejieshouCount", {});
                if (temp && temp.statusCode == 200) {
                    temp = temp.body.string();
                    let rep = JSON.parse(temp);
                    let repState = rep["state"];
        ...
        function getConfig() {
            let temp = null;
            try {
                temp = http.post("116.205.139.36:8081/fanqie/getConfig", {});
                if (temp && temp.statusCode == 200) {
                    temp = temp.body.string();
                    let rep = JSON.parse(temp);
                    let repState = rep["state"];
                                                        ...
                                                        if (auto_tx) {
                                                            if (child.text().indexOf("番茄主") > -1 && child.clickable()) {
                                                                ...
                                                                for (let i = 0; i < 10; i++) {
                                                                    ...
                                                                    let zBtn = textMatches(/(.*停止阅读.*)/).findOne(15000);
                                                                    if (zBtn != null) {
                                                                        sleep(100)
                                                                        zBtn.click();
                                                                    } else {
                                                                    ...
                                                                    sleep(1000)
                                                                    click("继续访问")
                                                                    zBtn = textMatches(/(.*停止阅读.*)/).findOne(15000);
                                                                    if (zBtn != null) {
                                                                        sleep(100)
                                                                        zBtn.click();
                                                                    } else {
                                                            ...
                                                            if (child.text().indexOf("番茄副") > -1 && child.clickable()) {//随机点其中一个
                                                                ...
                                                                if (fanqiefuCount == 1 && random(0, 2) < 2) {
                                                                    ...
                                                                    for (let i = 0; i < 10; i++) {
                                                                        clickx(child.bounds().centerX(), child.bounds().centerY());
                                                                        let zBtn = textMatches(/(.*停止阅读.*|.*注册时间.*)/).findOne(15000);
                                                                        if (zBtn != null) {
                                                                        ...
                                                                        sleep(1000)
                                                                        click("继续访问")
                                                                        zBtn = textMatches(/(.*停止阅读.*|.*注册时间.*)/).findOne(15000);
                                                                        if (zBtn != null) {
                                                                            let rBtn = className("android.widget.ImageView").desc("返回").findOne(3000);
                                                                            if (rBtn != null && rBtn.parent() != null) {
                                                                                rBtn.parent().click();
