...
lastLinkTitle = repData["lastLinkTitle"] != undefined ? repData["lastLinkTitle"] : "";//上一文章的标题
       ...
       setInterval(结束未响应(), 6000);
        ...
        var settingPath = files.join(files.cwd(), "setting.txt")//1、定义文件路径
