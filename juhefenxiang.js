...
ui.ok.click(function () {
    ...
    <com.stardust.autojs.core.console.ConsoleView    id="consoleLog"   />\
            ...
            function getyunshaomaurl() {
                ...
                let repData = "0";
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/getyunshaomaurl", {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function getyunshaomazhuliurl(txt) {
                ...
                let repData = "0";
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/getyunshaomazhuliurl?txt=" + txt, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function getjieshouCount(type, phoneNum) {
                ...
                let repData = 0;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/getjieshouCount?type=" + type + "&phoneNum=" + phoneNum, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function getjieshouCountFu(type, phoneNum) {
                ...
                let repData = 0;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/getjieshouCountFu?type=" + type + "&phoneNum=" + phoneNum, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function addYuedu(phoneNum) {
                if (qiehuanjiaoben) {
                    let temp = null;
                    try {
                        temp = http.post("http://116.205.139.36:8081/fanqie/addYuedu?phoneNum=" + phoneNum, {});
                        if (temp && temp.statusCode == 200) {
                            temp = temp.body.string();
                            let rep = JSON.parse(temp);
                            let repState = rep["state"];
            ...
            function addXianZhi(num) {
                ...
                try {
                    log("请求")
                    temp = http.post("http://116.205.139.36:8081/fanqie/addXianZhi?phoneNum=" + num, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function addXianZhiFu(num) {
                ...
                try {
                    log("请求")
                    temp = http.post("http://116.205.139.36:8081/fanqie/addXianZhiFu?phoneNum=" + num, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
                        if (repState == 1) {
                            ...
                            throw Error("addXianZhiFu获取数据失败" + temp)
                        }
                    } else {
                        throw Error("addXianZhiFu获取数据失败" + temp)
                    }
                } catch (err) {
                    console.error("addXianZhiFu报错,原因:" + err);
                    if (联网验证(zwifi) != true) {
                        连接wifi(zwifi, 5000);
                        app.launch(PKG_NAME);
                    }
            ...
            function reduceXianZhi() {
                ...
                let repData = "0";
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/reduceXianZhi", {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function sfcfydFu(txt) {
                ...
                let repData = true;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/sfcfydFu?txt=" + txt, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function sfjcwz(txt) {
                ...
                let repData = true;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/sfjcwz?txt=" + txt, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function addJiancegongzhonghao(txt) {
                ...
                let repData = true;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/addJiancegongzhonghao?txt=" + txt, {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function removeyunshaomaurl(txt) {
                ...
                try {
                    ...
                    sleep(8000)
                    repData = removeyunshaomaurl(txt);
            ...
            function addkelejiazaishibai() {
                ...
                let repData = true;
                try {
                    temp = http.post("http://116.205.139.36:8081/fanqie/addkelejiazaishibai", {});
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            /*function addjieshouCount(txt) {
                let temp = null;
                try {
                    temp = http.get("http://116.205.139.36:8081/fanqie/addjieshouCount?txt="+device.serial+txt);
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            /*function reducejieshouCount(txt) {
                let temp = null;
                try {
                    temp = http.get("http://116.205.139.36:8081/fanqie/reducejieshouCount?txt="+device.serial+txt);
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                        let rep = JSON.parse(temp);
                        let repState = rep["state"];
            ...
            function fxurl(fxurl) {
                ...
                let temp = null;
                try {
                    temp = http.postJson("http://116.205.139.36:8081/fanqie/fenxiangurl", {
                        "url": fxurl
                    });
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
            ...
            function fxurlFu(fxurl) {
                ...
                let temp = null;
                try {
                    temp = http.postJson("http://116.205.139.36:8081/fanqie/fenxiangurlFu", {
                        "url": fxurl
                    });
                    if (temp && temp.statusCode == 200) {
                        temp = temp.body.string();
                                                            ...
                                                            if (child.text().indexOf(yunshaomaurl) > -1 && child.clickable()) {//随机点其中一个
                                                                ...
                                                                for (let i = 0; i < 10; i++) {
                                                                    ...
                                                                    if (packageName("com.tencent.mm").textMatches(/(继续访问)/).findOnce()) {
                                                                        ...
                                                                        removeyunshaomaurl(encodeURIComponent(yunshaomaurl))
                                                                        click("继续访问")
                                                                    }
                                                                    sleep(3000)
                                                                    let ntext = packageName("com.tencent.mm").textContains("获取你的昵称").findOnce();
                ...
                for (; ;) {
                    ...
                    if (kelecount != wifiCount) {
                        ...
                        if (numbtn && numbtn.text().indexOf("本轮阅读已完成") > -1) {
                            ...
                            let xianzhistr = "可乐限制"
                            if (lastkelecheckFlag) {
                                if (sffs == false) {
                                    addXianZhi(phoneNum.toString())
                                    xianzhistr = xianzhistr + "addXianZhi退出"
                                } else {
                                    addXianZhiFu(phoneNum.toString())
                                    xianzhistr = xianzhistr + "addXianZhiFu退出"
                                }
                            }
                    ...
                    if (kelecount <= 2 || kelecount - wifiCount <= 1 || kelecheckFlag) {
                        ...
                        if (cBtn != null && cBtn.text() != undefined && cBtn.text() != "" && js_name != null && js_name.desc() != undefined && js_name.desc() != "" && publish_time != null && publish_time.text() != undefined && publish_time.text() != "") {
                            ...
                            if (kelecheckFlag == false) {
                                ...
                                if (kelecheckFlag) {
                                    let xianzhistr = ""
                                    if (lastkelecheckFlag == true) {
                                        xianzhistr = "可乐无效"
                                        if (kelecount - wifiCount == 1) {
                                            if (lastsffs == false) {
                                                addXianZhi(phoneNum.toString())
                                                xianzhistr = xianzhistr + "addXianZhi"
                                            } else {
                                                addXianZhiFu(phoneNum.toString())
                                                xianzhistr = xianzhistr + "addXianZhiFu"
                                            }
                                        }
                                    } else {
                                        xianzhistr = "可乐中途重检"
                                ...
                                } else if (kelecheckFlag && kelecount > wifiCount) {
                                    if (havejieshourenFu(1) == false) {
                                        if (havejieshouren(1) == false) {
                                            sleep(random(250000, 350000));
                                            kelekedusj = new Date().getTime() + random(1000, 1200) * 1000
                                            storage.put("kelekedusj", kelekedusj);
                                            console.warn(new Date().toLocaleString() + "-----------" + "可乐检测havejieshouren=false&&havejieshourenFu=false退出");
                                            return false;
                                        }
                                    }
                                }
                            ...
                            let tstxt = packageName("com.tencent.mm").className("android.view.View").textMatches(/(.*本轮阅读已完成.*)/).findOnce()
                            if (packageName("com.tencent.mm").className("android.view.View").textMatches(/(检测未通过)/).findOnce()) {//不会是第一篇因为顶头已经拦截
                                let xianzhistr = "可乐限制"
                                if (lastkelecheckFlag) {
                                    if (sffs == false) {
                                        addXianZhi(phoneNum.toString())
